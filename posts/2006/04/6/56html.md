<html><body><p>在我的印象中，Firefox是继承了Mozilla以前一个叫做Firebird的浏览器衣钵的。从前一直不温不火的，改名之后 火鸟重生为火狐，这下真火了。在M$垄断控制浏览器市场的现状下，<a href="http://marketshare.hitslink.com/report.aspx?qprid=0">大概有10%的市场占有率</a>。
